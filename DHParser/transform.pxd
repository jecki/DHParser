...
# cpdef is_one_of(context: List[Node], name_set: AbstractSet[str])
# cpdef not_one_of(context: List[Node], name_set: AbstractSet[str])
# cpdef matches_re(context: List[Node], patterns: AbstractSet[str])
# cpdef has_content(context: List[Node], regexp: str)
# cpdef has_ancestor(context: List[Node], name_set: AbstractSet[str])
...
# cpdef change_name(context: List[Node], name: str)
...
# cpdef move_fringes(context, condition: Callable = ?)
...
# cpdef keep_nodes(context: List[Node], names: AbstractSet[str])
...
# cpdef remove_children(context: List[Node], names: AbstractSet[str])
