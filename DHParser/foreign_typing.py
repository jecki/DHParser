# This module has been shamelessly stolen from the Python 3.5.3 sources
# in order for DHParser's static type annotations to be backwards
# compatible with Python 3.4.

# Therefore, this module is copyright by the Python Software Foundation
# and licensed under the Python Software Foundation License 2
# see typing.LICENSE for the details.
