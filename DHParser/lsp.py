...
def fromdict(D: JSON_Dict, DataClass: Any, keep_dict=False):
...
def typed_lsp_func(lsp_function):
    ...
    def type_guard(*args, **kwargs):
        ...
        call_params = fromdict(call_type, dict_obj)
        return_val = lsp_function(call_params)
        return asdict(return_val)
