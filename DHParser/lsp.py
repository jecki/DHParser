...
class CompletionList(TypedDict):
    ...
    class ApplyKind_0(TypedDict):
        ...
        # `completionList.itemDefaults.commitCharacters` and the completionʼs
    ...
    # @since 3.18.0
    applyKind: NotRequired[ApplyKind_0]
...
class InlineCompletionTriggerKind(TypedDict):
