...
:py:mod:`DHParser.dsl.create_parser`.
...
by executing the test-runner skript in the project-directory of
a DHParser-project. It consists of the following sections, dvided
...
3. The *AST-transformation* molds the concrete-syntax-tree into
   abstract-syntax-tree (AST) that represents the syntactical strucuture
...
of EBNF, a second attempt is made with the slower heuristical EBNF-parser.
...
Just as DHParser's (auto-)generated parser-skripts, the classes contained in
