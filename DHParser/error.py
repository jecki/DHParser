...
MANDATORY_CONTINUATION_AT_EOF_NON_ROOT   = ErrorCode(917)
...
CAPTURE_STACK_NOT_EMPTY_NON_ROOT_ONLY    = ErrorCode(952)
AUTOCAPTURED_SYMBOL_NOT_CLEARED          = ErrorCode(1055)
AUTOCAPTURED_SYMBOL_NOT_CLEARED_NON_ROOT = ErrorCode(957)
