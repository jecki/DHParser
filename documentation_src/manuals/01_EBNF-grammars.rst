...
*EBNF-Directives-Reference*
---------------------------

The following is a table of all EBNF-directives that DHParser supports.
EBNF-Directives how the grammar is interpreted and processed by DHParser.
...
Examples 2: Merge, hide and drop parts of the concrete syntax tree::
...
Example 3: Fail save parsing and Error Handling::
...
Examples 4: Other directives::
    ...
    @bracket_filter = matching_bracket  # matchingbracket = lambda s: {"(": ")", "[": "]"}[s]
