...
"""tst_indentation_grammar.py - runs the unit tests for the indentation-grammar
"""
...
if __name__ == '__main__':
    ...
    read_local_config(os.path.join(scriptdir, 'indentationConfig.ini'))
    ...
    if args.scripts:
        dsl.create_scripts(os.path.join(scriptdir, 'indentation.ebnf'))
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptdir, 'indentation.ebnf'),
                          force=False)
        sys.path.append('.')
        from indentationParser import parsing, ASTTransformation, preprocessing, \
