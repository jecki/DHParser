...
"""tst_simplifiedJSON_grammar.py - runs the unit tests for the simplifiedJSON-grammar
"""
...
if __name__ == '__main__':
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptpath, 'simplifiedJSON.ebnf'),
                          force=False)
        sys.path.append('.')
        from simplifiedJSONParser import get_grammar, get_transformer
