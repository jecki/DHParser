...
class reGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:_illegal$|_escape$|_item$|_anyChar$|_nibble$|_repeater$|_entity$|BS$|_grpItem$|_extension$|_octal$|_escapedCh$|_number$|_special$|_character$|EOF$)')
