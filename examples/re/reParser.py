...
class reGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:_escapedCh$|_chars$|_escape$|_anyChar$|_grpChars$|_item$|_char$|_number$|_grpItem$|_group$|_special$|_extension$|_illegal$|_grpChar$|_ch$|BS$|EOF$|_octal$|_entity$|_nibble$)')
