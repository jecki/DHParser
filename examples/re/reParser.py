...
class reGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:EOF$|_illegal$|_nibble$|_anyChar$|_escape$|_grpItem$|_character$|_escapedCh$|_octal$|BS$|_item$|_entity$|_number$|_special$|_repeater$|_extension$)')
