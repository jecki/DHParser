...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidCharsSingleQuoted$|EncName$|VersionNum$|prolog$|PubidChars$|Misc$|CData$|NameChars$|BOM$|XmlPIAtts$|NameStartChar$|EOF$|tagContent$|CommentChars$|Reference$)')
