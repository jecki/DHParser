...
class HTMLGrammar(Grammar):
    ...
    """
    element = Forward()
    source_hash__ = "b6b4cf37f1f08dd8c39d9d79214890a2"
    early_tree_reduction__ = CombinedParser.MERGE_TREETOPS
    disposable__ = re.compile('(?:PubidChars$|CommentChars$|prolog$|Reference$|BOM$|CData$|EOF$|tagContent$|VersionNum$|EncName$|NameChars$|Misc$|PubidCharsSingleQuoted$|NameStartChar$)')
