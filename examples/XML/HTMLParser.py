...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:Reference$|Misc$|NameChars$|PubidChars$|PubidCharsSingleQuoted$|CData$|CommentChars$|EncName$|prolog$|EOF$|VersionNum$|BOM$|tagContent$|NameStartChar$)')
