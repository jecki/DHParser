...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameStartChar$|NameChars$|PubidCharsSingleQuoted$|EncName$|CommentChars$|Reference$|tagContent$|CData$|EOF$|VersionNum$|Misc$|prolog$|BOM$|PubidChars$)')
