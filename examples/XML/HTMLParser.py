...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameStartChar$|tagContent$|Reference$|NameChars$|EncName$|VersionNum$|PubidChars$|BOM$|prolog$|Misc$|EOF$|PubidCharsSingleQuoted$|CData$|CommentChars$)')
