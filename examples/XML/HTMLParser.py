...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameStartChar$|CData$|PubidChars$|prolog$|BOM$|Reference$|tagContent$|Misc$|VersionNum$|NameChars$|PubidCharsSingleQuoted$|EncName$|CommentChars$|EOF$)')
