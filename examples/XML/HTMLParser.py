...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:Misc$|CData$|Reference$|PubidCharsSingleQuoted$|EncName$|BOM$|PubidChars$|prolog$|VersionNum$|EOF$|NameChars$|NameStartChar$|tagContent$|CommentChars$)')
