...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidChars$|Reference$|BOM$|VersionNum$|NameChars$|Misc$|CommentChars$|EOF$|EncName$|PubidCharsSingleQuoted$|CData$|prolog$|NameStartChar$|tagContent$)')
