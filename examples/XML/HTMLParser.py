...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:prolog$|Misc$|VersionNum$|NameChars$|tagContent$|NameStartChar$|Reference$|PubidChars$|CommentChars$|PubidCharsSingleQuoted$|CData$|EncName$|EOF$|BOM$)')
