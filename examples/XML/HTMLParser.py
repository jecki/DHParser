...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidChars$|EncName$|NameChars$|EOF$|BOM$|PubidCharsSingleQuoted$|VersionNum$|CommentChars$|NameStartChar$|prolog$|tagContent$|CData$|Reference$|Misc$)')
