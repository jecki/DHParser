...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:CommentChars$|Reference$|tagContent$|Misc$|NameChars$|BOM$|PubidChars$|prolog$|EOF$|VersionNum$|CData$|PubidCharsSingleQuoted$|EncName$|NameStartChar$)')
