...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidChars$|BOM$|Reference$|CData$|NameStartChar$|Misc$|NameChars$|tagContent$|EOF$|prolog$|EncName$|VersionNum$|PubidCharsSingleQuoted$|CommentChars$)')
