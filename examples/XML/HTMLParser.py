...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:$.)|(?:VersionNum$|PubidChars$|EncName$|PubidCharsSingleQuoted$|CData$|NameChars$|Reference$|Misc$|BOM$|CommentChars$|prolog$|EOF$|NameStartChar$|tagContent$)')
