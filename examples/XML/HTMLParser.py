...
class HTMLGrammar(Grammar):
    ...
    """
    element = Forward()
    source_hash__ = "540b04b9432cbaa29541d5f899888115"
    early_tree_reduction__ = CombinedParser.MERGE_TREETOPS
    disposable__ = re.compile('(?:CData$|CommentChars$|PubidChars$|VersionNum$|Misc$|Reference$|tagContent$|BOM$|PubidCharsSingleQuoted$|EncName$|prolog$|EOF$|NameChars$|NameStartChar$)')
