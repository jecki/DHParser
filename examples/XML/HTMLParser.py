...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:Misc$|BOM$|PubidCharsSingleQuoted$|prolog$|NameChars$|PubidChars$|CData$|tagContent$|CommentChars$|NameStartChar$|Reference$|EOF$|VersionNum$|EncName$)')
