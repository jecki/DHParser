...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidChars$|PubidCharsSingleQuoted$|VersionNum$|BOM$|NameChars$|prolog$|EncName$|EOF$|CData$|Misc$|tagContent$|Reference$|CommentChars$|NameStartChar$)')
