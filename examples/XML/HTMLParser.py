...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:BOM$|NameStartChar$|prolog$|Misc$|EncName$|Reference$|EOF$|CommentChars$|CData$|tagContent$|NameChars$|PubidChars$|PubidCharsSingleQuoted$|VersionNum$)')
