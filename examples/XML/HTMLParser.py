...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:CommentChars$|VersionNum$|EncName$|NameChars$|CData$|Misc$|EOF$|NameStartChar$|BOM$|PubidChars$|PubidCharsSingleQuoted$|tagContent$|prolog$|Reference$)')
