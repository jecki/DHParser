...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:Reference$|NameStartChar$|PubidCharsSingleQuoted$|CommentChars$|EncName$|NameChars$|VersionNum$|tagContent$|prolog$|CData$|EOF$|PubidChars$|BOM$|Misc$)')
