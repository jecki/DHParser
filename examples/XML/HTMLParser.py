...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:BOM$|CData$|EOF$|tagContent$|EncName$|PubidChars$|NameChars$|CommentChars$|NameStartChar$|PubidCharsSingleQuoted$|Reference$|prolog$|Misc$|VersionNum$)')
