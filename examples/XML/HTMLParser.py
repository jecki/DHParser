...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:$.)|(?:NameStartChar$|Misc$|PubidChars$|VersionNum$|EOF$|prolog$|BOM$|tagContent$|EncName$|PubidCharsSingleQuoted$|CData$|CommentChars$|NameChars$|Reference$)')
