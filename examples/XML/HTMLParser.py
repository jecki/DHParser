...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameStartChar$|CData$|EOF$|PubidCharsSingleQuoted$|Reference$|EncName$|NameChars$|VersionNum$|CommentChars$|Misc$|BOM$|tagContent$|PubidChars$|prolog$)')
