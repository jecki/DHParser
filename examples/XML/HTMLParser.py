...
class HTMLGrammar(Grammar):
    ...
    """
    element = Forward()
    source_hash__ = "c304ec91f348bb117a69f46ed4d1a825"
    early_tree_reduction__ = CombinedParser.MERGE_TREETOPS
    disposable__ = re.compile('(?:prolog$|CommentChars$|BOM$|Reference$|VersionNum$|CData$|NameStartChar$|Misc$|NameChars$|EncName$|EOF$|PubidChars$|tagContent$|PubidCharsSingleQuoted$)')
