...
class HTMLGrammar(Grammar):
    ...
    """
    element = Forward()
    source_hash__ = "e2b4e50e0976bccf5ed6e3d7541a9fc1"
    early_tree_reduction__ = CombinedParser.MERGE_TREETOPS
    disposable__ = re.compile('(?:BOM$|NameChars$|PubidChars$|PubidCharsSingleQuoted$|EncName$|Reference$|CData$|EOF$|tagContent$|prolog$|NameStartChar$|Misc$|CommentChars$|VersionNum$)')
