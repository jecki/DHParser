...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:$.)|(?:Misc$|prolog$|BOM$|CData$|PubidChars$|NameStartChar$|Reference$|VersionNum$|EOF$|tagContent$|PubidCharsSingleQuoted$|CommentChars$|NameChars$|EncName$)')
