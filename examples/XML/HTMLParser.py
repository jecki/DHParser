...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:BOM$|NameStartChar$|PubidCharsSingleQuoted$|Misc$|VersionNum$|Reference$|EOF$|tagContent$|PubidChars$|CData$|prolog$|EncName$|CommentChars$|NameChars$)')
