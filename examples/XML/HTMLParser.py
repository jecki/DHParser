...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameChars$|PubidCharsSingleQuoted$|EOF$|PubidChars$|prolog$|CommentChars$|NameStartChar$|tagContent$|Reference$|BOM$|VersionNum$|Misc$|CData$|EncName$)')
