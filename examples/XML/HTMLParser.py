...
class HTMLGrammar(Grammar):
    ...
    """
    element = Forward()
    source_hash__ = "395ca438ef0cc9bb78c7adb0503f7a50"
    early_tree_reduction__ = CombinedParser.MERGE_TREETOPS
    disposable__ = re.compile('(?:tagContent$|NameStartChar$|Misc$|BOM$|CommentChars$|EOF$|PubidCharsSingleQuoted$|VersionNum$|PubidChars$|EncName$|NameChars$|Reference$|prolog$|CData$)')
