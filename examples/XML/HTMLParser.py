...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:CommentChars$|BOM$|Misc$|CData$|prolog$|EncName$|PubidCharsSingleQuoted$|NameStartChar$|EOF$|tagContent$|PubidChars$|NameChars$|Reference$|VersionNum$)')
