...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidCharsSingleQuoted$|EncName$|PubidChars$|VersionNum$|CData$|EOF$|CommentChars$|NameStartChar$|Reference$|tagContent$|BOM$|prolog$|NameChars$|Misc$)')
