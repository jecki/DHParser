...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:tagContent$|Misc$|NameStartChar$|PubidCharsSingleQuoted$|Reference$|CData$|EOF$|BOM$|prolog$|CommentChars$|EncName$|NameChars$|PubidChars$|VersionNum$)')
