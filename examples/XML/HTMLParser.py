...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:$.)|(?:PubidChars$|Reference$|prolog$|EOF$|EncName$|VersionNum$|NameChars$|BOM$|Misc$|PubidCharsSingleQuoted$|tagContent$|CData$|CommentChars$|NameStartChar$)')
