...
class HTMLGrammar(Grammar):
    ...
    source_hash__ = "321a54a84a5982e9ac90eee859a8624f"
    early_tree_reduction__ = CombinedParser.MERGE_TREETOPS
    disposable__ = re.compile('(?:prolog$|EncName$|CommentChars$|CData$|tagContent$|Misc$|Reference$|PubidCharsSingleQuoted$|BOM$|NameChars$|PubidChars$|EOF$|VersionNum$|NameStartChar$)')
