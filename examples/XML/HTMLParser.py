...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidChars$|NameStartChar$|BOM$|CommentChars$|PubidCharsSingleQuoted$|tagContent$|Misc$|EOF$|NameChars$|CData$|prolog$|VersionNum$|Reference$|EncName$)')
