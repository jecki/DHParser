...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:CommentChars$|prolog$|PubidChars$|NameStartChar$|NameChars$|tagContent$|VersionNum$|EOF$|BOM$|Reference$|Misc$|CData$|PubidCharsSingleQuoted$|EncName$)')
