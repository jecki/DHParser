...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:prolog$|Reference$|tagContent$|CommentChars$|NameStartChar$|BOM$|NameChars$|Misc$|PubidChars$|EncName$|CData$|PubidCharsSingleQuoted$|VersionNum$|EOF$)')
