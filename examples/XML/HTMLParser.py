...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:prolog$|Reference$|PubidCharsSingleQuoted$|EncName$|BOM$|CommentChars$|Misc$|PubidChars$|CData$|EOF$|VersionNum$|tagContent$|NameStartChar$|NameChars$)')
