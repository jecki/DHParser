...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidCharsSingleQuoted$|PubidChars$|NameStartChar$|CData$|EOF$|tagContent$|VersionNum$|Misc$|Reference$|BOM$|NameChars$|CommentChars$|EncName$|prolog$)')
