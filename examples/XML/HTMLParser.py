...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidChars$|NameChars$|Misc$|CommentChars$|prolog$|BOM$|tagContent$|PubidCharsSingleQuoted$|CData$|NameStartChar$|EncName$|Reference$|EOF$|VersionNum$)')
