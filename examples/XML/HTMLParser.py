...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:BOM$|prolog$|EOF$|NameStartChar$|CommentChars$|tagContent$|EncName$|PubidChars$|VersionNum$|Misc$|NameChars$|CData$|Reference$|PubidCharsSingleQuoted$)')
