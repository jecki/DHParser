...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:$.)|(?:PubidCharsSingleQuoted$|Misc$|EncName$|NameChars$|NameStartChar$|CommentChars$|PubidChars$|tagContent$|Reference$|VersionNum$|EOF$|prolog$|BOM$|CData$)')
