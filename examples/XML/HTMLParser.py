...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:VersionNum$|Reference$|PubidChars$|NameStartChar$|NameChars$|PubidCharsSingleQuoted$|tagContent$|EOF$|prolog$|EncName$|CData$|CommentChars$|BOM$|Misc$)')
