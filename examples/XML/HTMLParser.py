...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:VersionNum$|tagContent$|NameStartChar$|PubidChars$|Misc$|NameChars$|EncName$|BOM$|EOF$|CData$|prolog$|PubidCharsSingleQuoted$|Reference$|CommentChars$)')
