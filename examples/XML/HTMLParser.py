...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameStartChar$|NameChars$|VersionNum$|CData$|PubidChars$|Misc$|BOM$|EncName$|tagContent$|CommentChars$|Reference$|PubidCharsSingleQuoted$|EOF$|prolog$)')
