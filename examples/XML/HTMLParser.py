...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidChars$|EncName$|prolog$|NameStartChar$|NameChars$|CData$|PubidCharsSingleQuoted$|EOF$|BOM$|Misc$|VersionNum$|Reference$|tagContent$|CommentChars$)')
