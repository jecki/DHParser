...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidChars$|EncName$|BOM$|prolog$|Misc$|CData$|PubidCharsSingleQuoted$|EOF$|CommentChars$|Reference$|NameStartChar$|tagContent$|NameChars$|VersionNum$)')
