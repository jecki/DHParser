...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:BOM$|tagContent$|Reference$|PubidChars$|EncName$|EOF$|NameChars$|prolog$|CData$|CommentChars$|NameStartChar$|PubidCharsSingleQuoted$|VersionNum$|Misc$)')
