...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameStartChar$|BOM$|EncName$|PubidCharsSingleQuoted$|PubidChars$|VersionNum$|prolog$|tagContent$|CData$|Misc$|NameChars$|CommentChars$|EOF$|Reference$)')
