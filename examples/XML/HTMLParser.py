...
class HTMLGrammar(Grammar):
    ...
    """
    element = Forward()
    source_hash__ = "e66b31a632f54b85563da7e76ab68eb5"
    early_tree_reduction__ = CombinedParser.MERGE_TREETOPS
    disposable__ = re.compile('(?:EOF$|CData$|EncName$|BOM$|CommentChars$|prolog$|PubidChars$|NameChars$|PubidCharsSingleQuoted$|Misc$|VersionNum$|tagContent$|NameStartChar$|Reference$)')
