...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:EOF$|PubidCharsSingleQuoted$|VersionNum$|EncName$|prolog$|CommentChars$|Misc$|BOM$|PubidChars$|tagContent$|NameChars$|CData$|Reference$|NameStartChar$)')
