...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameChars$|EncName$|Reference$|CommentChars$|PubidChars$|CData$|EOF$|NameStartChar$|Misc$|BOM$|tagContent$|PubidCharsSingleQuoted$|VersionNum$|prolog$)')
