...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:Misc$|NameStartChar$|EncName$|BOM$|EOF$|Reference$|PubidChars$|prolog$|PubidCharsSingleQuoted$|CommentChars$|tagContent$|NameChars$|VersionNum$|CData$)')
