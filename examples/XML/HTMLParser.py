...
class HTMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:CData$|NameChars$|CommentChars$|Reference$|tagContent$|EOF$|PubidChars$|NameStartChar$|VersionNum$|EncName$|BOM$|PubidCharsSingleQuoted$|Misc$|prolog$)')
