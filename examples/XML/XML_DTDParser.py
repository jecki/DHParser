...
class XML_DTDGrammar(Grammar):
    ...
    source_hash__ = "ed57d77c17776d312c3f1d78c9853644"
    ...
    children = Series(Alternative(choice, seq), Option(SmartRE('\\?|\\*|\\+', '"?"|"*"|"+"')))
    ...
    cp.set(Series(Alternative(Name, choice, seq), Option(SmartRE('\\?|\\*|\\+', '"?"|"*"|"+"'))))
