...
class XML_W3C_SPECGrammar(Grammar):
    ...
    source_hash__ = "471ad1de675380410a8e80ea32ee6a53"
    ...
    PubidChar = SmartRE("([\\x20]|[\\x0D]|[\\x0A]|[a-zA-Z0-9]|[-\\'()+,./:=?;!*#@$_%])", "/[\\x20]/|/[\\x0D]/|/[\\x0A]/|/[a-zA-Z0-9]/|/[-\\'()+,./:=?;!*#@$_%]/")
    ...
    EncName = Series(RegExp('[A-Za-z]'), ZeroOrMore(SmartRE('([A-Za-z0-9._])|(?P<:Text>\\-)', '/[A-Za-z0-9._]/|"-"')))
    S = OneOrMore(SmartRE('([\\x20]|[\\x09]|[\\x0D]|[\\x0A])', '/[\\x20]/|/[\\x09]/|/[\\x0D]/|/[\\x0A]/'))
    Eq = Series(Option(S), Text('='), Option(S))
    VersionNum = Series(Text('1.'), OneOrMore(RegExp('[0-9]')))
    NameStartChar = SmartRE('(?P<:Text>:)|([A-Z])|(?P<:Text>_)|([a-z]|[\\xC0-\\xD6]|[\\xD8-\\xF6]|[\\xF8-\\u02FF]|[\\u0370-\\u037D]|[\\u037F-\\u1FFF]|[\\u200C-\\u200D]|[\\u2070-\\u218F]|[\\u2C00-\\u2FEF]|[\\u3001-\\uD7FF]|[\\uF900-\\uFDCF]|[\\uFDF0-\\uFFFD]|[\\U00010000-\\U000EFFFF])', '":"|/[A-Z]/|"_"|/[a-z]/|/[\\xC0-\\xD6]/|/[\\xD8-\\xF6]/|/[\\xF8-\\u02FF]/|/[\\u0370-\\u037D]/|/[\\u037F-\\u1FFF]/|/[\\u200C-\\u200D]/|/[\\u2070-\\u218F]/|/[\\u2C00-\\u2FEF]/|/[\\u3001-\\uD7FF]/|/[\\uF900-\\uFDCF]/|/[\\uFDF0-\\uFFFD]/|/[\\U00010000-\\U000EFFFF]/')
    ...
    Char = SmartRE('([\\x09]|[\\x0A]|[\\x0D]|[\\x20-\\uD7FF]|[\\uE000-\\uFFFD]|[\\U00010000-\\U0010FFFF])', '/[\\x09]/|/[\\x0A]/|/[\\x0D]/|/[\\x20-\\uD7FF]/|/[\\uE000-\\uFFFD]/|/[\\U00010000-\\U0010FFFF]/')
    ...
    TokenizedType = SmartRE('(?P<:Text>IDREFS|IDREF|ID|ENTITY|ENTITIES|NMTOKENS|NMTOKEN)', '"IDREFS"|"IDREF"|"ID"|"ENTITY"|"ENTITIES"|"NMTOKENS"|"NMTOKEN"')
    ...
    children = Series(Alternative(choice, seq), Option(SmartRE('(?P<:Text>\\?|\\*|\\+)', '"?"|"*"|"+"')))
    ...
    Ignore = Series(NegativeLookahead(Series(ZeroOrMore(Char), SmartRE('(?P<:Text><!\\[|\\]\\]>)', '"<!["|"]]>"'), ZeroOrMore(Char))), ZeroOrMore(Char))
    ...
    SDDecl = Series(S, Text('standalone'), Eq, Alternative(Series(Text("\'"), SmartRE('(?P<:Text>yes|no)', '"yes"|"no"'), Text("\'")), Series(Text('"'), SmartRE('(?P<:Text>yes|no)', '"yes"|"no"'), Text('"'))))
    ...
    PITarget = Series(NegativeLookahead(Series(SmartRE('(?P<:Text>X|x)', '"X"|"x"'), SmartRE('(?P<:Text>M|m)', '"M"|"m"'), SmartRE('(?P<:Text>L|l)', '"L"|"l"'))), Name)
    ...
    cp.set(Series(Alternative(Name, choice, seq), Option(SmartRE('(?P<:Text>\\?|\\*|\\+)', '"?"|"*"|"+"'))))
...
def XML_W3C_SPECTransformer() -> TransformerFunc:
