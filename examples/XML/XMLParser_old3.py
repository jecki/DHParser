...
class XMLTransformer(Compiler):
    ...
    Example: The syntax-tree of the XML-Text:
    "<line>Herz, mein Herz ist traurig</line>" which is::
        ...
        (document
          (element
            (STag
              (Name "line"))
            (content
              (CharData "Herz, mein Herz ist traurig"))
            (ETag
              (Name "line"))))

    will be transformed into the data-tree of the data encoded by
    that very XML-Text which, obviously, should be::

        (line "Herz, mein Herz ist traurig")

    As of now, processing instructions, cdata-sections a document-type definition
