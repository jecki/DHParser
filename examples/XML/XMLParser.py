...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:CData$|BOM$|PubidCharsSingleQuoted$|EOF$|VersionNum$|prolog$|NameStartChar$|Reference$|tagContent$|CommentChars$|NameChars$|PubidChars$|EncName$|Misc$)')
