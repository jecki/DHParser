...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidCharsSingleQuoted$|PubidChars$|NameStartChar$|Reference$|CommentChars$|Misc$|CData$|EOF$|tagContent$|NameChars$|VersionNum$|EncName$|BOM$|prolog$)')
