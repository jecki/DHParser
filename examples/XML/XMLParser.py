...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameChars$|NameStartChar$|VersionNum$|BOM$|CommentChars$|XmlPIAtts$|PubidCharsSingleQuoted$|Reference$|PubidChars$|EncName$|tagContent$|Misc$|EOF$|prolog$|CData$)')
