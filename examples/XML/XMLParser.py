...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:XmlPIAtts$|PubidCharsSingleQuoted$|VersionNum$|EncName$|Misc$|BOM$|EOF$|prolog$|Reference$|CData$|NameChars$|tagContent$|NameStartChar$|PubidChars$|CommentChars$)')
