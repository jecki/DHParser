...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:EncName$|CommentChars$|PubidCharsSingleQuoted$|BOM$|NameStartChar$|VersionNum$|tagContent$|NameChars$|Reference$|PubidChars$|CData$|prolog$|Misc$|EOF$)')
