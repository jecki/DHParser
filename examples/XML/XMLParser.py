...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:XmlPIAtts$|EncName$|tagContent$|NameStartChar$|prolog$|PubidChars$|NameChars$|BOM$|VersionNum$|CData$|EOF$|PubidCharsSingleQuoted$|CommentChars$|Reference$|Misc$)')
