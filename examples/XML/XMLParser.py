...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:tagContent$|prolog$|NameStartChar$|PubidChars$|VersionNum$|Reference$|CommentChars$|NameChars$|PubidCharsSingleQuoted$|EOF$|XmlPIAtts$|CData$|BOM$|Misc$|EncName$)')
