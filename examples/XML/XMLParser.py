...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:$.)|(?:EncName$|PubidCharsSingleQuoted$|VersionNum$|NameStartChar$|Reference$|tagContent$|BOM$|Misc$|CommentChars$|NameChars$|prolog$|CData$|PubidChars$|EOF$)')
