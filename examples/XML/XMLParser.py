...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameChars$|PubidCharsSingleQuoted$|EOF$|XmlPIAtts$|CData$|CommentChars$|tagContent$|PubidChars$|Misc$|prolog$|Reference$|EncName$|NameStartChar$|VersionNum$|BOM$)')
