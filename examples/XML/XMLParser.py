...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:EncName$|Reference$|tagContent$|CommentChars$|PubidCharsSingleQuoted$|CData$|Misc$|BOM$|EOF$|PubidChars$|prolog$|VersionNum$|NameStartChar$|NameChars$|XmlPIAtts$)')
