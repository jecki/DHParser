...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidChars$|BOM$|EOF$|VersionNum$|EncName$|NameStartChar$|PubidCharsSingleQuoted$|NameChars$|CommentChars$|prolog$|Reference$|CData$|tagContent$|Misc$)')
