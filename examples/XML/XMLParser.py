...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidCharsSingleQuoted$|CData$|NameStartChar$|EOF$|BOM$|VersionNum$|EncName$|tagContent$|PubidChars$|prolog$|NameChars$|Reference$|Misc$|CommentChars$)')
