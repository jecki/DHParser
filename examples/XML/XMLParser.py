...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameStartChar$|EncName$|EOF$|NameChars$|CData$|PubidChars$|CommentChars$|tagContent$|Reference$|PubidCharsSingleQuoted$|prolog$|XmlPIAtts$|VersionNum$|BOM$|Misc$)')
