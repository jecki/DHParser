...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidCharsSingleQuoted$|CData$|VersionNum$|EOF$|tagContent$|Misc$|EncName$|prolog$|NameChars$|CommentChars$|BOM$|PubidChars$|NameStartChar$|Reference$|XmlPIAtts$)')
