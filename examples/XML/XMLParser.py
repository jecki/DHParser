...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:tagContent$|prolog$|BOM$|XmlPIAtts$|CData$|NameStartChar$|EOF$|PubidCharsSingleQuoted$|CommentChars$|EncName$|Misc$|Reference$|PubidChars$|VersionNum$|NameChars$)')
