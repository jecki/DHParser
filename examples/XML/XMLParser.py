...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:CommentChars$|CData$|VersionNum$|BOM$|PubidChars$|NameStartChar$|PubidCharsSingleQuoted$|EncName$|Reference$|NameChars$|Misc$|EOF$|prolog$|tagContent$)')
