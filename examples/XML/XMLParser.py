...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:EncName$|BOM$|prolog$|Reference$|EOF$|tagContent$|NameChars$|NameStartChar$|Misc$|CommentChars$|PubidChars$|CData$|VersionNum$|PubidCharsSingleQuoted$)')
