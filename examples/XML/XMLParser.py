...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:VersionNum$|BOM$|CommentChars$|PubidCharsSingleQuoted$|EOF$|PubidChars$|EncName$|Misc$|CData$|NameStartChar$|prolog$|NameChars$|tagContent$|Reference$)')
