...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:EncName$|tagContent$|PubidCharsSingleQuoted$|CommentChars$|VersionNum$|Reference$|CData$|NameStartChar$|EOF$|prolog$|BOM$|PubidChars$|Misc$|NameChars$)')
