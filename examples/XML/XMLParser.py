...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:prolog$|CData$|Misc$|NameStartChar$|CommentChars$|VersionNum$|Reference$|PubidCharsSingleQuoted$|BOM$|PubidChars$|tagContent$|EncName$|EOF$|NameChars$)')
