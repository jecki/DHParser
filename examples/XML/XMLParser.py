...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameChars$|EOF$|CommentChars$|XmlPIAtts$|PubidCharsSingleQuoted$|VersionNum$|tagContent$|BOM$|Reference$|NameStartChar$|prolog$|EncName$|CData$|Misc$|PubidChars$)')
