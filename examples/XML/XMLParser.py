...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameStartChar$|XmlPIAtts$|Reference$|Misc$|CommentChars$|EOF$|PubidCharsSingleQuoted$|PubidChars$|BOM$|NameChars$|EncName$|prolog$|tagContent$|VersionNum$|CData$)')
