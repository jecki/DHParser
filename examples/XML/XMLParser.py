...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:prolog$|EncName$|BOM$|Reference$|CData$|NameStartChar$|PubidCharsSingleQuoted$|tagContent$|PubidChars$|EOF$|Misc$|VersionNum$|NameChars$|CommentChars$)')
