...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:tagContent$|EOF$|Misc$|prolog$|BOM$|Reference$|NameStartChar$|PubidChars$|PubidCharsSingleQuoted$|VersionNum$|CData$|CommentChars$|NameChars$|EncName$)')
