...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:prolog$|EOF$|PubidChars$|CommentChars$|CData$|Reference$|PubidCharsSingleQuoted$|tagContent$|XmlPIAtts$|Misc$|VersionNum$|NameStartChar$|EncName$|BOM$|NameChars$)')
