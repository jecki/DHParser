...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:prolog$|PubidCharsSingleQuoted$|BOM$|CData$|EncName$|EOF$|VersionNum$|CommentChars$|tagContent$|Misc$|Reference$|NameChars$|PubidChars$|NameStartChar$)')
