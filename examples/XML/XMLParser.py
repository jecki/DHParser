...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:VersionNum$|Reference$|PubidCharsSingleQuoted$|CommentChars$|EOF$|NameChars$|tagContent$|BOM$|CData$|EncName$|Misc$|prolog$|NameStartChar$|PubidChars$)')
