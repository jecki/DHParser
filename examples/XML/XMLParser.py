...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidCharsSingleQuoted$|CData$|EncName$|Reference$|Misc$|CommentChars$|NameChars$|tagContent$|BOM$|NameStartChar$|PubidChars$|prolog$|VersionNum$|EOF$)')
