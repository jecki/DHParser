...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:$.)|(?:VersionNum$|EncName$|CommentChars$|tagContent$|EOF$|NameChars$|PubidCharsSingleQuoted$|Reference$|CData$|PubidChars$|BOM$|prolog$|NameStartChar$|Misc$)')
