...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameChars$|PubidChars$|tagContent$|BOM$|prolog$|NameStartChar$|CData$|PubidCharsSingleQuoted$|Reference$|EOF$|CommentChars$|EncName$|VersionNum$|Misc$)')
