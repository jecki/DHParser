...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:$.)|(?:PubidChars$|NameChars$|VersionNum$|EOF$|tagContent$|PubidCharsSingleQuoted$|Reference$|prolog$|CData$|BOM$|EncName$|NameStartChar$|Misc$|CommentChars$)')
