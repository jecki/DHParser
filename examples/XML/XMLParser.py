...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:prolog$|PubidCharsSingleQuoted$|EOF$|BOM$|XmlPIAtts$|EncName$|NameChars$|VersionNum$|tagContent$|Misc$|Reference$|CommentChars$|CData$|NameStartChar$|PubidChars$)')
