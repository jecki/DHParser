...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:Misc$|PubidCharsSingleQuoted$|VersionNum$|BOM$|PubidChars$|tagContent$|CommentChars$|NameChars$|EOF$|NameStartChar$|Reference$|EncName$|prolog$|CData$)')
