...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidChars$|VersionNum$|prolog$|CData$|NameStartChar$|Misc$|PubidCharsSingleQuoted$|BOM$|Reference$|CommentChars$|EOF$|EncName$|NameChars$|tagContent$)')
