...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:$.)|(?:prolog$|BOM$|NameChars$|PubidCharsSingleQuoted$|Reference$|PubidChars$|CData$|Misc$|tagContent$|EncName$|VersionNum$|EOF$|NameStartChar$|CommentChars$)')
