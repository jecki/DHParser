...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:Misc$|EncName$|NameStartChar$|NameChars$|BOM$|PubidCharsSingleQuoted$|CData$|tagContent$|Reference$|PubidChars$|EOF$|CommentChars$|prolog$|VersionNum$)')
