...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameChars$|NameStartChar$|EOF$|PubidChars$|BOM$|CData$|tagContent$|VersionNum$|XmlPIAtts$|prolog$|Misc$|PubidCharsSingleQuoted$|CommentChars$|EncName$|Reference$)')
