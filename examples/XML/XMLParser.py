...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameStartChar$|CommentChars$|CData$|PubidChars$|EOF$|VersionNum$|prolog$|Reference$|tagContent$|PubidCharsSingleQuoted$|EncName$|BOM$|Misc$|NameChars$)')
