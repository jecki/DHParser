...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:Reference$|NameStartChar$|PubidCharsSingleQuoted$|Misc$|BOM$|prolog$|EOF$|CData$|EncName$|PubidChars$|CommentChars$|tagContent$|VersionNum$|NameChars$)')
