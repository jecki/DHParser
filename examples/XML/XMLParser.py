...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:prolog$|Reference$|BOM$|CommentChars$|EncName$|CData$|VersionNum$|NameChars$|PubidChars$|tagContent$|PubidCharsSingleQuoted$|NameStartChar$|Misc$|EOF$)')
