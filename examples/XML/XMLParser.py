...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:CommentChars$|NameStartChar$|VersionNum$|tagContent$|Reference$|PubidChars$|XmlPIAtts$|CData$|BOM$|Misc$|prolog$|NameChars$|PubidCharsSingleQuoted$|EOF$|EncName$)')
