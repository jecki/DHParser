...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:$.)|(?:VersionNum$|EncName$|Reference$|Misc$|prolog$|CommentChars$|BOM$|PubidCharsSingleQuoted$|EOF$|NameChars$|PubidChars$|NameStartChar$|tagContent$|CData$)')
