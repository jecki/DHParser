...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NameChars$|VersionNum$|EncName$|EOF$|BOM$|PubidChars$|CData$|CommentChars$|PubidCharsSingleQuoted$|tagContent$|NameStartChar$|prolog$|Reference$|Misc$)')
