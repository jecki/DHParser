...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:$.)|(?:CommentChars$|prolog$|EOF$|PubidChars$|VersionNum$|Misc$|BOM$|NameStartChar$|tagContent$|PubidCharsSingleQuoted$|CData$|EncName$|NameChars$|Reference$)')
