...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:$.)|(?:VersionNum$|CommentChars$|prolog$|PubidCharsSingleQuoted$|Reference$|tagContent$|CData$|Misc$|NameStartChar$|EncName$|NameChars$|BOM$|EOF$|PubidChars$)')
