...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidCharsSingleQuoted$|CData$|NameChars$|BOM$|CommentChars$|NameStartChar$|Reference$|EOF$|Misc$|VersionNum$|prolog$|tagContent$|PubidChars$|EncName$)')
