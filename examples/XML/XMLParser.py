...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:PubidCharsSingleQuoted$|Misc$|NameStartChar$|XmlPIAtts$|Reference$|PubidChars$|VersionNum$|NameChars$|EOF$|CData$|tagContent$|CommentChars$|EncName$|BOM$|prolog$)')
