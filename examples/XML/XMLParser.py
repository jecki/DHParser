...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:CommentChars$|VersionNum$|CData$|Misc$|PubidCharsSingleQuoted$|EncName$|NameChars$|EOF$|BOM$|NameStartChar$|prolog$|tagContent$|Reference$|PubidChars$)')
