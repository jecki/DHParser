...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:BOM$|VersionNum$|NameChars$|PubidCharsSingleQuoted$|PubidChars$|EOF$|CommentChars$|Reference$|EncName$|tagContent$|Misc$|CData$|NameStartChar$|prolog$)')
