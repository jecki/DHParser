...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:BOM$|CData$|VersionNum$|EncName$|PubidCharsSingleQuoted$|CommentChars$|XmlPIAtts$|NameStartChar$|Misc$|PubidChars$|prolog$|Reference$|NameChars$|EOF$|tagContent$)')
