...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:$.)|(?:NameStartChar$|EOF$|EncName$|Misc$|BOM$|CommentChars$|prolog$|Reference$|PubidCharsSingleQuoted$|CData$|NameChars$|PubidChars$|VersionNum$|tagContent$)')
