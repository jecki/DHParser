...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:EncName$|prolog$|tagContent$|PubidChars$|VersionNum$|Misc$|BOM$|XmlPIAtts$|CommentChars$|NameStartChar$|Reference$|CData$|EOF$|PubidCharsSingleQuoted$|NameChars$)')
