...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:EOF$|tagContent$|CData$|CommentChars$|PubidChars$|EncName$|prolog$|PubidCharsSingleQuoted$|NameStartChar$|VersionNum$|Reference$|BOM$|NameChars$|Misc$)')
