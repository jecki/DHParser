...
class XMLGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:CommentChars$|BOM$|Reference$|tagContent$|NameStartChar$|EncName$|Misc$|prolog$|PubidChars$|EOF$|VersionNum$|CData$|PubidCharsSingleQuoted$|NameChars$)')
