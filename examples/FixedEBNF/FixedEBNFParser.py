...
class FixedEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "fa027d5f4af70893239a5f4f49ebd3d6"
    disposable__ = re.compile('(?:..(?<=^))|(?:ANY_SUFFIX$|MOD_SYM$|component$|MOD_SEP$|is_mdef$|no_range$|FOLLOW_UP$|pure_elem$|EOF$|countable$)')
