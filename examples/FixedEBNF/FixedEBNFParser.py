...
class FixedEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "53d989c0447675a237196f85d93f5876"
    disposable__ = re.compile('(?:is_mdef$|pure_elem$|EOF$|FOLLOW_UP$|MOD_SYM$|countable$|component$|no_range$|ANY_SUFFIX$|MOD_SEP$)')
