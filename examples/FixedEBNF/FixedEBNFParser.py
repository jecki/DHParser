...
class FixedEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "c4406519149bff0a9d09efeea53d442a"
    disposable__ = re.compile('(?:pure_elem$|is_mdef$|MOD_SEP$|component$|ANY_SUFFIX$|FOLLOW_UP$|EOF$|MOD_SYM$|countable$|no_range$)')
