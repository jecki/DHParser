...
class FixedEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "4a1b0ce3a5b42c5db43921fa9bbe7dba"
    disposable__ = re.compile('(?:MOD_SYM$|ANY_SUFFIX$|countable$|component$|pure_elem$|FOLLOW_UP$|MOD_SEP$|is_mdef$|EOF$|no_range$)')
