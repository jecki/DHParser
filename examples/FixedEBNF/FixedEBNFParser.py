...
class FixedEBNFGrammar(Grammar):
    ...
    source_hash__ = "3906cfad4339b2b3ddc65a791bab2aa6"
    disposable__ = re.compile('(?:countable$|ANY_SUFFIX$|is_mdef$|MOD_SYM$|FOLLOW_UP$|MOD_SEP$|component$|EOF$|no_range$|pure_elem$)')
