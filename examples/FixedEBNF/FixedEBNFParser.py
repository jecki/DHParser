...
class FixedEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "00b6d54cf2d2e8480053cd9a31f82266"
    disposable__ = re.compile('(?:pure_elem$|MOD_SEP$|FOLLOW_UP$|no_range$|ANY_SUFFIX$|EOF$|is_mdef$|component$|MOD_SYM$|countable$)')
