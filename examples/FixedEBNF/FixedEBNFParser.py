...
class FixedEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "7b16125dd04967b63392ff1e1be237a2"
    disposable__ = re.compile('(?:pure_elem$|is_mdef$|no_range$|FOLLOW_UP$|ANY_SUFFIX$|countable$|EOF$|MOD_SEP$|component$|MOD_SYM$)')
