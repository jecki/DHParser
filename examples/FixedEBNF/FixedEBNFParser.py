...
class FixedEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "b1dbf789ba219d631697df1fdcdc9166"
    disposable__ = re.compile('(?:no_range$|is_mdef$|FOLLOW_UP$|MOD_SYM$|ANY_SUFFIX$|MOD_SEP$|countable$|EOF$|pure_elem$|component$)')
