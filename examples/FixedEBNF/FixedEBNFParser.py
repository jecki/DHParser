...
class FixedEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "d9105e7e168f4247f1ebc7d9ab99fb14"
    disposable__ = re.compile('(?:EOF$|ANY_SUFFIX$|component$|MOD_SEP$|MOD_SYM$|pure_elem$|countable$|no_range$|FOLLOW_UP$|is_mdef$)')
