...
class FixedEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "e3269c240373f324f31b35f4179eb3cc"
    disposable__ = re.compile('(?:..(?<=^))|(?:countable$|no_range$|ANY_SUFFIX$|is_mdef$|MOD_SEP$|component$|EOF$|FOLLOW_UP$|pure_elem$|MOD_SYM$)')
