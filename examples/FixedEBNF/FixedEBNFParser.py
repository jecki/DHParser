...
class FixedEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "a3ec3cda723f70b7fce72c0400e166c3"
    disposable__ = re.compile('(?:ANY_SUFFIX$|is_mdef$|EOF$|no_range$|countable$|MOD_SYM$|FOLLOW_UP$|MOD_SEP$|component$|pure_elem$)')
