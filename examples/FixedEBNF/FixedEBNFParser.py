...
class FixedEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "5eee25f4dd7be784284fabcb2d3d50da"
    disposable__ = re.compile('(?:EOF$|is_mdef$|ANY_SUFFIX$|component$|MOD_SYM$|FOLLOW_UP$|no_range$|MOD_SEP$|pure_elem$|countable$)')
