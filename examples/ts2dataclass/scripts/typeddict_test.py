...
import sys
try:
    from typing import Generic, ClassVar, Final, Protocol, _GenericAlias, \
    ...
    from typing_extensions import Generic, ClassVar, Final, Protocol, \
        NoReturn, TypeVar, TypedDict, _TypedDictMeta, PEP_560
    if PEP_560:
        from typing_extensions import get_origin
    else:
        def get_origin(T):
            return T.__origin__
    from typing import List, Iterable, Callable, Tuple, Optional, Union, Any, Dict, get_type_hints
...
if __name__ == '__main__':
    t = Test(a=1, t=T1(s="hello"), c=T2(x=3.1415), g=G(value=(1, 2, 3)))
    print(t)
