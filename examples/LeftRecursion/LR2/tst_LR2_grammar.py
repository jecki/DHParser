...
"""tst_LR2_grammar.py - runs the unit tests for the LR2-grammar
"""
...
if __name__ == '__main__':
    ...
    if args.scripts:
        dsl.create_scripts(os.path.join(scriptdir, 'LR2.ebnf'))
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptdir, 'LR2.ebnf'),
                          force=False)
        sys.path.append('.')
        from LR2Parser import parsing, ASTTransformation, preprocessing, \
