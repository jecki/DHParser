...
"""tst_InterwovenLR_grammar.py - runs the unit tests for the InterwovenLR-grammar
"""
...
if __name__ == '__main__':
    ...
    if args.scripts:
        dsl.create_scripts(os.path.join(scriptdir, 'InterwovenLR.ebnf'))
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptdir, 'InterwovenLR.ebnf'),
                          force=False)
        sys.path.append('.')
        from InterwovenLRParser import parsing, ASTTransformation, preprocessing, \
