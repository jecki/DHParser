...
"""tst_indirect_grammar.py - runs the unit tests for the indirect-grammar
"""
...
if __name__ == '__main__':
    ...
    if args.scripts:
        dsl.create_scripts(os.path.join(scriptdir, 'indirect.ebnf'))
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptdir, 'indirect.ebnf'),
                          force=False)
        sys.path.append('.')
        from indirectParser import parsing, ASTTransformation, preprocessing, \
