...
"""tst_direct_hidden_grammar.py - runs the unit tests for the direct_hidden-grammar
"""
...
if __name__ == '__main__':
    ...
    if args.scripts:
        dsl.create_scripts(os.path.join(scriptdir, 'direct_hidden.ebnf'))
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptdir, 'direct_hidden.ebnf'),
                          force=False)
        sys.path.append('.')
        from direct_hiddenParser import parsing, ASTTransformation, preprocessing, \
