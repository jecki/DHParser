...
"""tst_InterwovenLR2_grammar.py - runs the unit tests for the InterwovenLR2-grammar
"""
...
if __name__ == '__main__':
    ...
    if args.scripts:
        dsl.create_scripts(os.path.join(scriptdir, 'InterwovenLR2.ebnf'))
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptdir, 'InterwovenLR2.ebnf'),
                          force=False)
        sys.path.append('.')
        from InterwovenLR2Parser import parsing, ASTTransformation, preprocessing, \
