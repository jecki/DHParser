...
"""tst_LR_grammar.py - runs the unit tests for the LR-grammar
"""
...
if __name__ == '__main__':
    ...
    if args.scripts:
        dsl.create_scripts(os.path.join(scriptdir, 'LR.ebnf'))
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptdir, 'LR.ebnf'),
                          force=False)
        sys.path.append('.')
        from LRParser import parsing, ASTTransformation, preprocessing, \
