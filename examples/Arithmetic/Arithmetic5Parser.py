...
class Arithmetic5Grammar(Grammar):
    ...
    source_hash__ = "3a0df5ce22546fdb85ee6e060cdf9fd1"
...
compiling: Junction = Junction(
    'AST', ThreadLocalSingletonFactory(Arithmetic5Compiler), 'Arithmetic5')
...
#     "Arithmetic5", ThreadLocalSingletonFactory(PostProcessing), "refined")
#
