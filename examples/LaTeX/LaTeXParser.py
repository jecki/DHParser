...
class LaTeXGrammar(Grammar):
    ...
    _env_name = Drop(Alternative(Drop(Text("enumerate")), Drop(Text("itemize")), Drop(Text("description")), Drop(Text("figure")), Drop(Text("quote")), Drop(Text("quotation")), Drop(Text("tabular")), Series(Drop(Text("displaymath")), Option(Drop(Text("*")))), Series(Drop(Text("equation")), Option(Drop(Text("*")))), Series(Drop(Text("eqnarray")), Option(Drop(Text("*"))))))
    blockcmd = Series(_BACKSLASH, Alternative(Series(Alternative(SmartRE(fr"(?:begin\{{)(?:{WSP_RE__})", "\"begin{\""), SmartRE(fr"(?:end\{{)(?:{WSP_RE__})", "\"end{\"")), _env_name, SmartRE(fr"(?:\}})(?:{WSP_RE__})", "\"}\"")), Series(_structure_name, Lookahead(Drop(Text("{")))), Drop(Text("[")), Drop(Text("]")), _item_name))
    no_command = Alternative(SmartRE(fr"(?:\\begin\{{)(?:{WSP_RE__})", "\"\\begin{\""), SmartRE(fr"(?:\\end\{{)(?:{WSP_RE__})", "\"\\end{\""), Series(_BACKSLASH, _structure_name, Lookahead(Drop(Text("{")))))
    ...
    config = Series(SmartRE(fr"(?:\[)(?:{WSP_RE__})", "\"[\""), Alternative(Series(parameters, Lookahead(SmartRE(fr"(?:\])(?:{WSP_RE__})", "\"]\""))), cfg_text), SmartRE(fr"(?:\])(?:{WSP_RE__})", "\"]\""), mandatory=1)
    ...
    ref = Series(Alternative(SmartRE(fr"(?:\\ref\{{)(?:{WSP_RE__})", "\"\\ref{\""), SmartRE(fr"(?:\\pageref\{{)(?:{WSP_RE__})", "\"\\pageref{\"")), CHARS, SmartRE(fr"(?:\}})(?:{WSP_RE__})", "\"}\""))
    ...
    citep = Series(Alternative(SmartRE(fr"(?:\\citep)(?:{WSP_RE__})", "\"\\citep\""), SmartRE(fr"(?:\\cite)(?:{WSP_RE__})", "\"\\cite\"")), Option(config), block)
    ...
    tabular_row = Series(Alternative(multicolumn, tabular_cell), ZeroOrMore(Series(SmartRE(fr"(?:\&)(?:{WSP_RE__})", "\"&\""), Alternative(multicolumn, tabular_cell))), Alternative(Series(SmartRE(fr"(?:\\\\)(?:{WSP_RE__})", "\"\\\\\""), Alternative(hline, ZeroOrMore(cline)), Option(_PARSEP)), Lookahead(Drop(Text("\\end{tabular}")))))
