...
class FlexibleEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "dd071d8d2e291017aadd7dc85da82ac1"
    disposable__ = re.compile('(?:MOD_SEP$|ANY_SUFFIX$|MOD_SYM$|EOF$|component$|no_range$|is_mdef$|FOLLOW_UP$|countable$|pure_elem$)')
