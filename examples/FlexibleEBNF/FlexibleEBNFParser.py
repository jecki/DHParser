...
class FlexibleEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "a245de43373048f77784f7200365c6a8"
    disposable__ = re.compile('(?:EOF$|no_range$|pure_elem$|countable$|component$|MOD_SEP$|ANY_SUFFIX$|is_mdef$|MOD_SYM$|FOLLOW_UP$)')
