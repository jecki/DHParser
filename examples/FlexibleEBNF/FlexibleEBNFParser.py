...
class FlexibleEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "7061b124746f8604f4aab1d957fe6d5e"
    disposable__ = re.compile('(?:is_mdef$|no_range$|countable$|MOD_SYM$|FOLLOW_UP$|MOD_SEP$|EOF$|component$|ANY_SUFFIX$|pure_elem$)')
