...
class FlexibleEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "f0b11c368409344a1c0927ebb8f9c261"
    disposable__ = re.compile('(?:is_mdef$|ANY_SUFFIX$|component$|EOF$|countable$|no_range$|FOLLOW_UP$|MOD_SYM$|pure_elem$|MOD_SEP$)')
