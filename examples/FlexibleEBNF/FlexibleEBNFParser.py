...
class FlexibleEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "3af6ecf4ad66c03a3e2af18958699ca6"
    disposable__ = re.compile('(?:pure_elem$|no_range$|EOF$|countable$|component$|MOD_SYM$|MOD_SEP$|ANY_SUFFIX$|is_mdef$|FOLLOW_UP$)')
