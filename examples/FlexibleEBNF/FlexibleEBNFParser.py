...
class FlexibleEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "67fb3d8e13f7acb960d86086d1bcce9c"
    disposable__ = re.compile('(?:$.)|(?:EOF$|component$|is_mdef$|FOLLOW_UP$|MOD_SEP$|MOD_SYM$|no_range$|countable$|ANY_SUFFIX$|pure_elem$)')
