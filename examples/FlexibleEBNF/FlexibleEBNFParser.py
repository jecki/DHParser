...
class FlexibleEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "1c42d6c43039fca915bdd6651f0418b2"
    disposable__ = re.compile('(?:MOD_SYM$|is_mdef$|component$|FOLLOW_UP$|MOD_SEP$|EOF$|countable$|pure_elem$|ANY_SUFFIX$|no_range$)')
