...
class FlexibleEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "295160b0e0efb23dd07a411223baf1fd"
    disposable__ = re.compile('(?:is_mdef$|EOF$|ANY_SUFFIX$|countable$|FOLLOW_UP$|pure_elem$|MOD_SYM$|component$|MOD_SEP$|no_range$)')
