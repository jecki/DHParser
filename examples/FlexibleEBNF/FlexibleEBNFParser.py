...
class FlexibleEBNFGrammar(Grammar):
    ...
    source_hash__ = "1e9975a105be936c7df97479a31ea086"
    disposable__ = re.compile('(?:FOLLOW_UP$|is_mdef$|ANY_SUFFIX$|MOD_SYM$|no_range$|EOF$|countable$|MOD_SEP$|component$|pure_elem$)')
