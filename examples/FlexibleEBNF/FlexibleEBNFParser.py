...
class FlexibleEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "32d686b34543cead95d7e9da74e36a7a"
    disposable__ = re.compile('(?:pure_elem$|EOF$|component$|is_mdef$|FOLLOW_UP$|no_range$|ANY_SUFFIX$|countable$|MOD_SEP$|MOD_SYM$)')
