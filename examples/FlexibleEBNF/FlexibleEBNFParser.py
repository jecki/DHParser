...
class FlexibleEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "a1f96e26b8d5e41970c7d44a2f1d154f"
    disposable__ = re.compile('(?:EOF$|FOLLOW_UP$|ANY_SUFFIX$|pure_elem$|no_range$|countable$|MOD_SEP$|MOD_SYM$|component$|is_mdef$)')
