...
class FlexibleEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "18c36ad41e068e5f241628bb4036e433"
    disposable__ = re.compile('(?:EOF$|pure_elem$|MOD_SEP$|is_mdef$|MOD_SYM$|FOLLOW_UP$|countable$|no_range$|ANY_SUFFIX$|component$)')
