...
class FlexibleEBNFGrammar(Grammar):
    ...
    element = Forward()
    expression = Forward()
    source_hash__ = "a4731f8f7ef7c4eda5c9578d6e60d551"
    disposable__ = re.compile('(?:is_mdef$|EOF$|MOD_SYM$|ANY_SUFFIX$|no_range$|FOLLOW_UP$|MOD_SEP$|countable$|component$|pure_elem$)')
