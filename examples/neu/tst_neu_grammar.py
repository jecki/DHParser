...
"""tst_neu_grammar.py - runs the unit tests for the neu-grammar
"""
...
if __name__ == '__main__':
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptpath, 'neu.ebnf'),
                          force=False)
        sys.path.append('.')
        from neuParser import get_grammar, get_transformer
