    ...
    def finalize(self, python_code: Any) -> Any:
        if self.tree.tag_name == 'document':
            code_blocks = [
                ...
                GENERAL_IMPORTS, TYPEDDICT_IMPORTS]
...
if __name__ == "__main__":
    ...
    if args.debug or args.compatibility or args.base or args.decorator:
        access_presets()
        ...
        if args.decorator:  set_preset_value('ts2python.ClassDecorator', args.decorator[0])
        if args.peps:
