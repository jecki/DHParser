...
\input{00_Vorwort.tex}
%\newpage 

\chapter{Techniken des Entscheidens}

\input{01a_Einleitung_Baeume_Tabellen.tex}
\newpage
\input{01b_Einleitung_Baeume_Tabellen_Aufgaben.tex}
 
\newpage
\input{02a_Unwissenheit_ordinal.tex} 
\newpage
\input{02b_Unwissenheit_ordinal_Aufgaben.tex}

% \newpage
% \input{03a_Unwissenheit_kardinal.tex}
% \newpage
% \input{03b_Unwissenheit_kardinal_Aufgaben.tex}

% \newpage
% \input{04a_Risiko.tex}
% \newpage
% \input{04b_Risiko_Aufgaben.tex}


% \chapter{Zur Theorie der Kollektiven Entscheidungen}

% \input{05a_Sozialwahltheorie.tex}
% \newpage
% \input{05b_Sozialwahltheorie_Aufgaben.tex}

% \newpage
% \input{06a_Sozialwahltheorie_Diskussion.tex}
% \newpage
% \input{06b_Sozialwahltheorie_Diskussion_Aufgaben.tex}



% \chapter{Wahrscheinlichkeitsrechnung}

% \input{07a_Wahrscheinlichkeiten_Rechentechniken.tex}
% \newpage
% \input{07b_Wahrscheinlichkeiten_Rechentechniken_Aufgaben.tex}

% \newpage
% \input{08a_Wahrscheinlichkeiten_Interpretationsfragen.tex}
% \newpage
% \input{08b_Wahrscheinlichkeiten_Interpretationsfragen_Aufgaben.tex}



% \chapter{Neumann-Morgensternsche Nutzentheorie} 

% \input{09a_Neumann-Morgenstern.tex}
% \newpage
% \input{09b_Neumann-Morgenstern_Aufgaben.tex}

% \newpage
% \input{10a_Neumann-Morgenstern_Diskussion.tex}
% \newpage
% \input{10b_Neumann-Morgenstern_Diskussion_Aufgaben.tex}
 

% \chapter{Spieltheorie}

% \input{11a_Spieltheorie_Einfuehrung.tex}
% \newpage
% \input{11b_Spieltheorie_Einfuehrung_Aufgaben.tex}

% \newpage
% \input{12a_Spieltheorie_Anwendung.tex}
% \newpage
% \input{12b_Spieltheorie_Anwendung_Aufgaben.tex}


% \chapter{Kritische Reflexion}
% \input{13a_Wissenschaftstheorie.tex}
...
% \input{20_KlausurUebung.tex}
% \newpage
% \input{21_Klausur.tex}
% \newpage
