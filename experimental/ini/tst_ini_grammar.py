...
"""tst_ini_grammar.py - runs the unit tests for the ini-grammar
"""
...
if __name__ == '__main__':
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptpath, 'ini.ebnf'),
                          force=False)
        sys.path.append('.')
        from iniParser import get_grammar, get_transformer
